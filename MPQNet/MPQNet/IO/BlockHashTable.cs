...
//namespace MPQNet.IO
//{
//    internal class BlockHashTable : IMPQHashTable
//    {
//        private RawHashEntry[] _HashTable;

//        private RawBlockEntry[] _BlockTable;

//        public BlockHashTable(ILowLevelIOHandler IOHandler, long hashOffset, int hashCount, long blockOffset, int blockCount)
//        {
//            _HashTable = ReadTable<RawHashEntry>(IOHandler, hashOffset, hashCount, SpecialFiles.HashTableKey);
//            _BlockTable = ReadTable<RawBlockEntry>(IOHandler, blockOffset, blockCount, SpecialFiles.BlockTableKey);
//        }
...
//                {
//                    if (currentBlock.BlockIndex == RawHashEntry.HASH_ENTRY_NO_LONGER_VALID)
//                    {
//                        value = default;
//                        return false;
//                    }
...
//                    return true;
//                }
//                if (currentBlock.BlockIndex == RawHashEntry.HASH_ENTRY_IS_EMPTY)
//                {
//                    value = default;
//                    return false;
//                }
